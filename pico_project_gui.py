...
# This file is only imported and run when the GUI is requested. If this file is deleted the GUI will not be accessable 

# Importing anything we need
import sys
import subprocess
import shlex
import os
...
from pico_project_gui import DisplayWindow
